...
namespace Project.Common.UI
{
    public class CursorBaseRaycaster : BaseRaycaster
    {
        ...
        public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
        {
            ...
            {
                ray = new(_cursorTransform.position, Vector3.forward);
            }
            Debug.DrawRay(_cursorTransform.position, Vector3.forward);
            ...
            Raycast(canvas, currentEventCamera, _cursorTransform.position, canvasGraphics, m_RaycastResults);
            ...
            for (var index = 0; index < totalCount; index++)
            {
                ...
                if (appendGraphic)
                {
                    ...
                    var castResult = new RaycastResult
                    {
                        ...
                        module = this,
                        distance = distance,
                        screenPosition = _cursorTransform.position,
